...
namespace Negocio
{
    ...
    public static class ProveedorService
    {
        ...
        public static IProveedor CrearProveedor(string nombre, string cuit, string direccion, ETipoDeProductoProveido tipoDeproducto, EMediosDePago medioDePago, EAcreedor esAcreedor, EDiaDeLaSemana diaDeEntrega)
        {
